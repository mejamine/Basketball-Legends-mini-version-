...
img1= score1.render('LEBRON', True,BLEND_ADD)
score2 = pygame.font.SysFont(None,60)
img2= score2.render('WADE', True,BLEND_ADD)
...
player1 = pygame.image.load("wade.png").convert_alpha()
player2 = pygame.image.load("lebron.png").convert_alpha()
